package com.pskwiercz.rag.tools;
...
public class PIIMaskProcessor implements DocumentPostProcessor {

    private static final Logger logger = LoggerFactory.getLogger(PIIMaskProcessor.class);
    ...
    public static PIIMaskProcessor builder() {
        return new PIIMaskProcessor();
    }
}